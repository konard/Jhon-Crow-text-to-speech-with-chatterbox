...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'torchaudio',
        'torch',
        # Perth watermarking (used by chatterbox)
        'perth',
        'perth.perth_net',
        'perth.perth_net.perth_net_implicit',
        'perth.perth_net.perth_net_implicit.perth_watermarker',
        'perth.perth_net.perth_net_implicit.model',
        'perth.perth_net.perth_net_implicit.model.perth_net',
        'perth.perth_net.perth_net_implicit.checkpoint_manager',
        'perth.perth_net.perth_net_implicit.audio_processor',
        'perth.perth_net.perth_net_implicit.config',
        ...
        'tkinter.filedialog',
        'tkinter.messagebox',
        # pkg_resources for perth model loading
        'pkg_resources',
    ],
